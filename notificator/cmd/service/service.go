...
import (
	...
	"flag"
	"fmt"
	endpoint "github.com/efrengarcial/godemo/notificator/pkg/endpoint"
	grpc "github.com/efrengarcial/godemo/notificator/pkg/grpc"
	pb "github.com/efrengarcial/godemo/notificator/pkg/grpc/pb"
	service "github.com/efrengarcial/godemo/notificator/pkg/service"
...
func registerService(logger log.Logger) (*sdetcd.Registrar, error) {
	var (
		etcdServer = "http://etcd:2379" //"http://localhost:23791"
